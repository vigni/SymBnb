...
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, max=255, minMessage="Votre desciption ne peux pas faire moins de 100 caractères!")
     */
    private $content;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Image::class, mappedBy="ad", cascade="all", orphanRemoval=true)
     * @Assert\Valid()
     */
    private $images;
